...
class MainPage(Handler):
    ...
    def post(self):
        ...
        # render welcome/redirect
        # re-render form if false
        ...
        newText = self.request.get("text").encode('rot13')
        self.render("form.html", rotText=newText)
...
def query():
    ...
    sorted(links, key=lambda Link: Link.submitted_time)
    for link in links:
        if link.submitter_id==62443:
        query_list.append(link.url)
